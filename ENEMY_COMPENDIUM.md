...
**Demo today:** `drifter` mobs (1 HP) — see [`enemy-types.js`](enemy-types.js).
...
|------|-----|----------|-------|----------------|-------|
| Ground Walker | 1 | Slow horizontal / gentle float | Very slow | Food (candy/cake) | Most common; predictable |
...
| **Drifter** | **1** | Erratic float / random paths | Slow | — | Unpredictable wildcard (**in demo**) |
| Saucer | 1 | Circles, figure-8, darts | Medium–fast | — | Tricky skill target |
...
| Wall Clinger (static) | 1 | Stationary on walls | Stationary | Food | Easy points |
